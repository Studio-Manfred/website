  ...
  return (
    <>
      ...
      <main id="main" tabIndex={-1}>
        <Section background="white" width="narrow" padding="tight">
          <h1
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "2.5rem" }}>
            ...
            <PolicySection heading="What data do we collect?">
            ...
            <PolicySection heading="How do we collect your data?">
            ...
            <PolicySection heading="How will we use your data?">
            ...
            <PolicySection heading="How do we store your data?">
            ...
            <PolicySection heading="Marketing">
            ...
            <PolicySection heading="What are your data protection rights?">
            ...
            <PolicySection heading="What types of cookies do we use?">
            ...
            <PolicySection heading="How to manage cookies">
            ...
            <PolicySection heading="Privacy policies of other websites">
            ...
            <PolicySection heading="Changes to our privacy policy">
