            ...
            <div className="flex flex-col md:flex-row gap-20">
              ...
              <div className="flex-1 min-w-0 flex flex-col gap-16">
                ...
                <div>
                  ...
                  <p
                    className="font-light text-[var(--color-text-primary)] mb-4"
                ...
                <div>
                  ...
                  <p
                    className="font-light text-[var(--color-text-secondary)] mb-6"
                    style={{ fontSize: "clamp(1rem, 1.5vw, 1.2rem)", lineHeight: 1.75 }}
                  >
                  ...
                  {[
                    {
                      ...
                      text: "Designed and executed frameworks for ~30 interviews and observational studies with B2B clients, alongside interviews with end-consumers.",
                    },
                    {
                      heading: "Continuous feedback loop",
                      text: "Established a long-term user panel to create an efficient, ongoing feedback mechanism for future product iterations.",
                    },
                    {
                      heading: "AI & operational efficiency",
                      text: "Explored long-term AI capabilities to streamline internal customer-facing operations and workflows.",
                    },
                    {
                      heading: "Quantitative survey",
                      text: "Distributed a broad survey combining qualitative and quantitative questions to validate findings across all B2B customer segments.",
                    },
                    {
                      heading: "Synthesis & business mapping",
                      text: "Analysed and merged all data streams to identify future product needs across segments, aligning user pains with business potential to drive prioritization.",
                    },
                  ].map((item) => (
                    <div key={item.heading} className="border-t border-[var(--color-border-default)] py-5">
                      ...
                      <p
                        ...
                        style={{ fontSize: "clamp(0.95rem, 1.3vw, 1.05rem)", lineHeight: 1.7 }}
                      >
                        {item.text}
                      </p>
                    </div>
                ...
                <div>
                  ...
                  <div className="flex flex-col gap-8">
                    <div>
                      ...
                      <iframe
                        src="/cases/bokadirekt/bokadirekt-matrix.html"
                    ...
                    <div>
                      ...
                      <iframe
                        src="/cases/bokadirekt/bokadirekt-distribution.html"
                        className="w-full border border-[var(--color-border-default)] rounded"
                        style={{ height: "360px" }}
                    ...
                    <div>
                      <p className="text-xs font-extrabold text-[var(--color-business-blue)] uppercase tracking-widest mb-3">
                        ICP Deep Dive — Example
                      </p>
                      <iframe
                        src="/cases/bokadirekt/bokadirekt-icp-example.html"
                        className="w-full border border-[var(--color-border-default)] rounded"
                        style={{ height: "600px" }}
                        title="ICP Deep Dive"
                      />
                ...
                <div>
                  ...
                  {[
                    {
                      heading: "Increased B2B retention",
                      text: "Directly boosted retention within key, high-priority B2B customer segments by acting on critical product improvements.",
                    },
                    {
                      heading: "Proactive churn reduction",
                      text: "Identified key churn indicators and underlying drivers, equipping the business with actionable insights to reduce churn in critical segments.",
                    },
                    {
                      heading: "Unified customer knowledge",
                      text: "Democratized qualitative and quantitative customer insights across all departments — aligning tech, product, marketing, and leadership around shared user understanding.",
                    },
                    {
                      heading: "Elevated research practice",
                      text: "Raised the overall standard and frequency of continuous product research and user discovery across product teams.",
                    },
                  ].map((item) => (
                    <div key={item.heading} className="border-t border-[var(--color-border-default)] py-5">
                      <p
